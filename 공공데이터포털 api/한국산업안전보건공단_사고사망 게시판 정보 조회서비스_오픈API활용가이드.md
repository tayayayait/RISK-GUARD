...
- 1) [사고사망 게시판 조회] 상세기능명세 (4p)

## 1. 서비스 명세

### 1.1 사고사망 게시판 정보 조회서비스
...
| --- | --- | --- | --- | --- |
| API 서비스 정보 | API명(영문) |   |   |   |
|   | API명(국문) | 사고사망 게시판 정보 조회서비스 |   |   |
|   | API 설명 | 한국산업안전보건공단 홈페이지(www.kosha.or.kr)에서 제공 중인 사고사망 게시판 정보를 실시간으로 조회하실 수 있도록 제공하는 데이터입니다. |   |   |
...
| API 서비스<br>배포정보 | 서비스 URL | http://apis.data.go.kr/B552468/news_api |   |   |
|   | 서비스 명세 URL<br>(WSDL 또는 WADL) | N/A |   |   |
|   | 서비스 버전 | 1.0 |   |   |
|   | 서비스 시작일 | 2023-08-18 | 서비스 배포일 | 2025-09-24 |
|   | 서비스 이력 | 2023-08-18 : 서비스 시작 |   |   |
...
| 1 | 사고사망 게시판 조회 서비스 | news_api | 사고사망 게시판 조회 |

#### 다. 상세기능내역

##### 1) [사고사망 게시판 조회] 상세기능명세
...
| 상세기능명(국문) | 사고사망 게시판 조회 |   |   |
| 상세기능 설명 | 최신목록 갯수 조건을 이용하여 사고사망 게시판의 제목과 내용 정보를 조회하는 기능 |   |   |
| Call Back URL | https://apis.data.go.kr/B552468/news_api/getNews_api |   |   |
...
| keyword | 제목 | 500 | 문자 | [7/6, 경기 김포시] 철골 위에서 볼트체결 작업 후 고소작업대로 이동하던 중 떨어짐(15m) | 사망사고 게시판 제목 |
| contents | 내용 | 4000 | 문자 | <img alt="" src="https://www.kosha.or.kr/cms/plugin/editorImage.do?EwBmGYHoQdkgbAygMwNYFcCqB7A4ugKQEkCB5AZwC8ArACQEN0B3AOmoAcBzIA " /><br /><br>.... | 사망사고 게시판 내용 |
...
```
http://apis.data.go.kr/B552468/news_api/getNews_api?ServiceKey=서비스키&numOfRows=10&pageNo=1
https://www.kosha.or.kr/kosha/news_api.do?SG_APIM=인증키&numOfRows=10&pageNo=1
```
...
"items":{
"item":[{
"keyword":" [8/4, 서울 노원] 자재에 깔림",
"contents":"<img alt=\"\" src=\"https://www.kosha.or.kr/c......
},
......
]
}
